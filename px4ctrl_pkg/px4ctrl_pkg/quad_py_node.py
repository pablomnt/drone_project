...
from px4_msgs.msg import ManualControlSetpoint, VehicleCommand, VehicleStatus, VehicleRatesSetpoint, OffboardControlMode, TrajectorySetpoint
...
class CmdVelToManualControl(Node):
    def __init__(self):
        ...
        self.offboard_msg.velocity = True    # We want to control velocity
    ...
    def joy_callback(self, msg):
        ...
        """
        if self.joy_input.buttons[1] == 1 and self.last_buttons[1] == 0:  # Circulo para stabilized mode
    ...
    def publish_manual_control(self):
        ...
        manual_control_msg.data_source = 1  # MAVLink instance 1 para UXV como joystick
